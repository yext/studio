 ...
 */
export default function areEqualFileMetadata(firstMetadata: FileMetadata, secondMetadata: FileMetadata): boolean {
...
function removeUndefined(metadata: FileMetadata): FileMetadata {
  return lodash.omitBy(metadata, value => value === undefined) as FileMetadata;
}