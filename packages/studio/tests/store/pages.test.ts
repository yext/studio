...
import { ComponentState, PageState, PropValueKind, PropValues, PropValueType } from '@yext/studio-plugin'
...
describe('PagesSlice', () => {
  ...
  describe('active page actions', () => {
    ...
    it('returns active page\'s state using getActivePageState', () => {
      const activePageState = useStudioStore.getState().pages.getActivePageState()
  ...
  describe('active component actions', () => {
    ...
    it('updates activeComponentUUID using setActiveComponentUUID', () => {
      ...
      const activeComponentUUID = useStudioStore.getState().pages.activeComponentUUID
    ...
    it('updates active component\'s prop values using setActiveComponentProps', () => {
      ...
      const actualPropValues = useStudioStore.getState().pages.pages['universal'].componentTree[1].props
    ...
    it('returns active component using getActiveComponent', () => {
      const activeComponent = useStudioStore.getState().pages.getActiveComponent()
