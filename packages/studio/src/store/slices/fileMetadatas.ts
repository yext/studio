...
export const createFileMetadatasSlice: SliceCreator<FileMetadatasSlice> = (set, get) => ({
  UUIDToFileMetadata: {},
  setFileMetadata: (uuid: string, metadata: FileMetadata) => set(store => {
  ...
  removeFileMetadata: (uuid: string) => set(store => {
